...
def import_saints():
    ...
    saints_data = [
        ...
        },
        {
            'id': 'st-patrick',
            'name': 'St. Patrick',
            'img': 'https://images.fineartamerica.com/images/artworkimages/mediumlarge/1/saint-patrick-jen-norton.jpg',
            'feast': 'March 17',
            'desc': 'Apostle of Ireland who transformed a pagan nation into the "Island of Saints and Scholars."',
            'categories': ['pastors', 'missionaries']
        },
    ]
...
def import_quotes():
    ...
    quotes_data = [
        ...
        {
            'id': 'q5',
            'text': 'Christ with me, Christ before me, Christ behind me, Christ within me.',
            'saint_id': 'st-patrick',
            'date': '2024-03-17'
        },
        {
...
if __name__ == '__main__':
    ...
    tables_exist = table_exists('core_category')
    ...
    print("Database tables found. Starting import...")
    print("=" * 50)
